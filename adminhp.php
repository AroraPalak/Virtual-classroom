...
<!--header --></br></br>
			<header>
				...
				<form id="search" method="post">		
					<fieldset>
						<div id="header_right">
							<h5> <a href="logout1.php">Log Out</a> </h5>
						</div>						 
					</fieldset>
				</form>
			</div>
			...
			<article id="content"> 
				...
				<nav>
					<ul id="menu">
						<li class="active"><a href="adminhp.php"><span>Homepage</span></a></li>
						<li><a href="dbfetch.php"><span>Student Details</span></a></li>
						<li><a href="dbfetch1.php">Tutor Details</a></li>
