...
<?php
	ob_start();
	echo' </br> <h3> <div align="center"> * Select the course to view the study material </div> </h3> </class> </br></br></br> ';
	...
	while($row = mysql_fetch_array($b, MYSQL_ASSOC))
		...
		if($sub=='English')
			{if($class=='V')
				...
				echo '<p class="pad_bot1"><a href="engXII.php">English for Class XII</a></p>';
			}
		if($sub=='Hindi')
			{if($class=='V')
		...
		if($sub=='Mathematics')
			{if($class=='V')
				...
				echo '<p class="pad_bot1"><a href="mathVI.php">Mathematics for Class VI</a></p>';
			else if($class=='VII')
				...
				echo '<p class="pad_bot1"><a href="mathXII.php">Mathematics for Class XII</a></p>';
			}
		if($sub=='Science')
			{if($class=='V')
				...
				echo '<p class="pad_bot1"><a href="sciIX.php">Science for Class IX</a></p>';
			else if($class=='X')
